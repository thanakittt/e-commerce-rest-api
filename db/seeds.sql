...
-- 7. Seed Orders
INSERT INTO orders (id, user_id, status, order_date) OVERRIDING SYSTEM VALUE VALUES
    (1, 2, 'paid', NOW() - INTERVAL '10 days'),
    (2, 2, 'shipped', NOW() - INTERVAL '4 days'),
    (3, 3, 'pending', NOW() - INTERVAL '2 days'),
    (4, 4, 'cancelled', NOW() - INTERVAL '1 day');
